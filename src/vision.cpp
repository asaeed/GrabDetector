...
void Vision::update(){
    ...
    if (bNewFrame){
        ...
        colorImage.setFromPixels(colorImagePixels);
        ...
        colorPrevPixels = colorImagePixels;
    }
...
void Vision::draw(){
    ...
    redDiff.draw(ofGetWidth() - vidWidth, vidHeight * 2);
    greenDiff.draw(ofGetWidth() - vidWidth, vidHeight * 3);
    blueDiff.draw(ofGetWidth() - vidWidth, vidHeight * 4);
    
    // then draw the contours:
    int contourFinderX = ofGetWidth() - vidWidth;
    int contourFinderY = vidHeight * 6;
